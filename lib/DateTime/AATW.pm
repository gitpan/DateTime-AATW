...
Returns a DateTime::AATW object.  A vaild L<DateTime> object must be passed.
...
If you create a DateTime::AATW object with a L<DateTime> object based on UTC and call $aatw->zones_for_hour(2),
